	...
	slurm_step_launch_callbacks_t *step_callbacks)
{
	...
	launch_params.mpi_jobid         = job->mpi_jobid;
	launch_params.mpi_stepid        = job->mpi_stepid;
	launch_params.mpi_ntasks        = job->mpi_ntasks;
	launch_params.mpi_nnodes        = job->mpi_nnodes;
	launch_params.mpi_stepfnodeid   = job->mpi_stepfnodeid;
	launch_params.mpi_stepftaskid   = job->mpi_stepftaskid;
